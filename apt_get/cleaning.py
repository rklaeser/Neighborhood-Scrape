...
#df = pd.read_excel('/Users/Reed/PycharmProjects/akara/apt_get/Denver20180207-163324.xlsx')
...
# If getting error, rerun main(), the problem is that df is being redefined on top of itself
def Create_New():
    file = '/Users/Reed/PycharmProjects/akara/apt_get/data/data_unclean/midtown-nashville-nashville-tn/midtown-nashville-nashville-tn_clean20180208-143722.xlsx'
